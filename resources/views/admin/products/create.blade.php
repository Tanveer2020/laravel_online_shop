                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" readonly name="slug" id="slug" class="form-control" placeholder="Slug">                                         <p class="error"></p> 
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="price" id="price" class="form-control" placeholder="Price">                                                    <p class="error"></p>   
